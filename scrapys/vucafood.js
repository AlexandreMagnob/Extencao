          ...
          for await (const productIndex of [...Array(productCards.length).keys()]) {
            ...
            for await (const complementExpandable of complementExpandables) {
              ...
              for await (const complementElement of complementElements) {
                ...
                if(complementExpandable.querySelector('dl[style="display: none;"]')){
                  complementElement.click()
                }
                ...
                let optionsContainer = complementExpandable.querySelectorAll('dl[style="display:block"]')

                for await (const optionContainer of optionsContainer) {
